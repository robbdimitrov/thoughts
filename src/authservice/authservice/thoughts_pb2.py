...
_AUTHSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='thoughts.AuthService.ValidateSession',
    index=1,
    containing_service=None,
