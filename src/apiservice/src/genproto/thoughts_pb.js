 ...
 * @constructor
 */
proto.thoughts.Identifiers = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.thoughts.Identifiers.repeatedFields_, null);
};
goog.inherits(proto.thoughts.Identifiers, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.thoughts.Identifiers.displayName = 'proto.thoughts.Identifiers';
}
/**
 ...
 * @const
 */
proto.thoughts.Identifiers.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.thoughts.Identifiers.prototype.toObject = function(opt_includeInstance) {
  return proto.thoughts.Identifiers.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.thoughts.Identifiers} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.thoughts.Identifiers.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.thoughts.Identifiers}
 */
proto.thoughts.Identifiers.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.thoughts.Identifiers;
  return proto.thoughts.Identifiers.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.thoughts.Identifiers} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.thoughts.Identifiers}
 */
proto.thoughts.Identifiers.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.thoughts.Identifiers.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.thoughts.Identifiers.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.thoughts.Identifiers} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.thoughts.Identifiers.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<number>}
 */
proto.thoughts.Identifiers.prototype.getIdsList = function() {
  return /** @type {!Array<number>} */ (jspb.Message.getRepeatedField(this, 1));
};


/** @param {!Array<number>} value */
proto.thoughts.Identifiers.prototype.setIdsList = function(value) {
 ...
 */
proto.thoughts.Identifiers.prototype.addIds = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};


proto.thoughts.Identifiers.prototype.clearIdsList = function() {
  this.setIdsList([]);
};
