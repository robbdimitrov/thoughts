...
_DATAREQUEST = _descriptor.Descriptor(
  name='DataRequest',
  full_name='thoughts.DataRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='token', full_name='thoughts.DataRequest.token', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page', full_name='thoughts.DataRequest.page', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='limit', full_name='thoughts.DataRequest.limit', index=3,
...
_IDENTIFIERS = _descriptor.Descriptor(
  name='Identifiers',
  full_name='thoughts.Identifiers',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ids', full_name='thoughts.Identifiers.ids', index=0,
...
_AUTHSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='session_id', full_name='thoughts.AuthStatus.session_id', index=4,
...
_USERREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='username', full_name='thoughts.UserRequest.username', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token', full_name='thoughts.UserRequest.token', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_USERUPDATES = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='avatar', full_name='thoughts.UserUpdates.avatar', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token', full_name='thoughts.UserUpdates.token', index=7,
...
_POST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retweets', full_name='thoughts.Post.retweets', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retweeted', full_name='thoughts.Post.retweeted', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='date_created', full_name='thoughts.Post.date_created', index=7,
      number=8, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_POSTUPDATES = _descriptor.Descriptor(
  name='PostUpdates',
  full_name='thoughts.PostUpdates',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='post_id', full_name='thoughts.PostUpdates.post_id', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='content', full_name='thoughts.PostUpdates.content', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='token', full_name='thoughts.PostUpdates.token', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DataRequest = _reflection.GeneratedProtocolMessageType('DataRequest', (_message.Message,), dict(
  ...
  __module__ = 'thoughts_pb2'
  # @@protoc_insertion_point(class_scope:thoughts.DataRequest)
  ))
...
Identifiers = _reflection.GeneratedProtocolMessageType('Identifiers', (_message.Message,), dict(
  ...
  __module__ = 'thoughts_pb2'
  # @@protoc_insertion_point(class_scope:thoughts.Identifiers)
  ))
...
PostUpdates = _reflection.GeneratedProtocolMessageType('PostUpdates', (_message.Message,), dict(
  DESCRIPTOR = _POSTUPDATES,
  __module__ = 'thoughts_pb2'
  # @@protoc_insertion_point(class_scope:thoughts.PostUpdates)
  ))
_sym_db.RegisterMessage(PostUpdates)
...
_USERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='UpdatePassword',
    full_name='thoughts.UserService.UpdatePassword',
    index=3,
    containing_service=None,
    input_type=_USERUPDATES,
    output_type=_EMPTY,
...
_FOLLOWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='thoughts.FollowService.GetFollowingIds',
    index=1,
    containing_service=None,
    input_type=_USERREQUEST,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='thoughts.FollowService.GetFollowersIds',
    index=3,
    containing_service=None,
    input_type=_USERREQUEST,
    output_type=_IDENTIFIERS,
  ...
  _descriptor.MethodDescriptor(
    name='FollowUser',
    full_name='thoughts.FollowService.FollowUser',
    index=4,
    containing_service=None,
    input_type=_USERREQUEST,
    output_type=_EMPTY,
  ...
  _descriptor.MethodDescriptor(
    name='UnfollowUser',
    full_name='thoughts.FollowService.UnfollowUser',
    index=5,
    containing_service=None,
    input_type=_USERREQUEST,
    output_type=_EMPTY,
